...
export async function addBonkAddressesToTable(connection: Connection, lutAddress: PublicKey, mint: PublicKey, walletKPs: Keypair[], mainKp: Keypair, creator: PublicKey = mainKp.publicKey) {
  ...
  try {
    ...
    const creatorVault = getPdaCreatorVault(LAUNCHPAD_PROGRAM, creator, NATIVE_MINT).publicKey;
