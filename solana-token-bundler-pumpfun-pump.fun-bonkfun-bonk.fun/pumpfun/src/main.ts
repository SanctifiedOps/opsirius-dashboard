...
export async function addAddressesToTableMultiExtend(
  ...
  walletKPs: Keypair[],
  mainKp: Keypair,
  creator: PublicKey = mainKp.publicKey
) {
  ...
  try {
    ...
    const creatorVault = sdk.getCreatorVaultPda(sdk.program.programId, creator);
...
export async function addAddressesToTable(lutAddress: PublicKey, mint: PublicKey, walletKPs: Keypair[], mainKp: Keypair, creator: PublicKey = mainKp.publicKey) {
